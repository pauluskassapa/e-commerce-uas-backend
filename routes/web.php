...
Route::get('/products/{categorySlug}', [ProductController::class, 'byCategory'])->where('categorySlug', '^(?!create$)(?![0-9]+$)[A-Za-z0-9-]+$')->name('products.by-category');
...
Route::resource('profiles', ProfileController::class)->only(['index', 'show'])->middleware('auth');